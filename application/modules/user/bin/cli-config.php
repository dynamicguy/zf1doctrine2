...
$cache = new $ini['user']['resources']['entitymanagerfactory']['cache'];
...
$config->setProxyNamespace($ini['user']['resources']['entitymanagerfactory']['proxyNamespace']);

$config->setAutoGenerateProxyClasses($ini['user']['resources']['entitymanagerfactory']['autoGenerateProxyClasses']);

$connectionOptions = $ini['user']['resources']['entitymanagerfactory']['connectionOptions'];
